...
def train():
    ...
    elif training_mode == 'emo2':
        model = EMOLlama2ForCausalLM.from_pretrained(
            model_args.model_name_or_path,
            cache_dir=training_args.cache_dir,
        )
    ...
    if training_mode != 'mle':
        # emo or emo2
        # use llama-13B's lm head for computing transport cost C
        ...
        cost_embedding = copy.deepcopy(llama13b.lm_head.weight.data)
